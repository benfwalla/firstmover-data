...
const CURRENT_START = '2026-02-01';
const CURRENT_END = '2026-03-01';
const PREV_START = '2026-01-01';
const PREV_END = '2026-02-01';
const TREND_START = '2025-09-01'; // 6 months trailing

async function generate() {
  const client = await getDBClient();

  try {
    console.log('Generating March 2026 report data (February market)...');
    ...
    const neighborhoodChanges = (await client.query(`
      ...
      SELECT c.area_name, c.curr_median as jan_median, p.prev_median as dec_median,
    ...
    const outputPath = path.join(process.cwd(), 'src/data/march-2026-data.json');
