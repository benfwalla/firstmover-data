        ...
        <footer className="site-footer">
          <div className="container">
            <p style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
              Built by <a href="https://firstmovernyc.com" target="_blank" rel="noopener noreferrer" style={{ fontWeight: 600 }}>FirstMover</a>
              <a href="https://github.com/benfwalla/firstmover-open-data-project" target="_blank" rel="noopener noreferrer" style={{ opacity: 0.5, display: 'flex' }}>
