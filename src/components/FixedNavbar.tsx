      ...
      <div className="container">
        <div className="nav-container">
          ...
          <div className="nav-links">
            ...
            <a href="https://github.com/benfwalla/firstmover-open-data-project" target="_blank" rel="noopener noreferrer" className="nav-link" style={{ opacity: 0.4, display: 'flex', alignItems: 'center' }}>
