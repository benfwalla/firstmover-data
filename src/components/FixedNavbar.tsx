    ...
    <nav className="fixed-navbar">
      <div className="container">
        <div className="nav-container">
          <Link href="/open" className="nav-logo-link" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
          ...
          <div className="nav-links">
            <Link href="/open-data" className={`nav-link ${pathname.startsWith('/open-data') ? 'nav-link-active' : ''}`}>
              Open Data
            </Link>
            <Link href="/reports" className={`nav-link ${pathname.startsWith('/reports') ? 'nav-link-active' : ''}`}>
              Reports
            </Link>
            <Link href="/blog" className={`nav-link ${pathname.startsWith('/blog') ? 'nav-link-active' : ''}`}>
              Blog
            </Link>
            <Link href="/resources" className={`nav-link ${pathname.startsWith('/resources') ? 'nav-link-active' : ''}`}>
              Resources
            </Link>
